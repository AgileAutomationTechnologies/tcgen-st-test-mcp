...
The v0.8.4 Windows validation target is the AgileAutomationTechnologies STruC++
...
```powershell
npm run export:semantic-report-contract -- C:\temp\mcp-0.8.4-framework-assertion-report.json
```
