  ...
  properties: {
    ...
    technicalEvidence: {
      ...
      properties: {
        ...
        content: { type: "string" },
        sourceKind: { const: "generated_cpp" },
        generatedArtifacts: {
          type: "array",
          uniqueItems: true,
  ...
  return {
    ...
    frameworkAssertionEvidence: {
      ...
      properties: {
        ...
        checkpointOrdinal: { type: "integer", minimum: 1 },
    ...
    frameworkAssertionLedger: {
      ...
      additionalProperties: false,
      properties: {
        contract: { const: "tcgen-framework-assertion-ledger-v1" },
        ledgerSha256: { type: "string", pattern: "^[a-f0-9]{64}$" },
    ...
    standardFunctionBlockContracts: {
      ...
      properties: {
        schemaVersion: { const: 1 },
        schema: { const: "tcgen-iec-function-block-contracts-v1" },
        ...
        functionBlocks: {
          ...
          items: {
            type: "object",
            required: ["name", "inputs", "outputs", "inouts"],
            additionalProperties: false,
            properties: {
              name: { type: "string", minLength: 1 },
              inputs: {
